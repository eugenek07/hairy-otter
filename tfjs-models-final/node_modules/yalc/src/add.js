        ...
        switch (_a.label) {
            case 0:
                ...
                addedInstallsP = packages.map(function (packageName) { return __awaiter(void 0, void 0, void 0, function () {
                    var _a, name, _b, version, destYalcCopyDir, storedPackagePath, versionToInstall, storedPackageDir, pkg, replacedVersion, defaultPureMsg, destModulesDir, protocol, localAddress, dependencies, devDependencies, whereToAdd, binDir_1, addBinScript, name_1, addedAction, signature;
