...
var resolveDepVersion = function (pkgName, workingDir) {
    var _a;
    try {
...
exports.copyPackageToStore = function (pkg, options) { return __awaiter(void 0, void 0, void 0, function () {
    var workingDir, _a, devMod, copyFromDir, storePackageStoreDir, ignoreFileContent, ignoreRule, npmList, filesToCopy, copyFilesToStore, hashes, _b, signature, publishedSig, versionPre, resolveDeps, pkgToWrite;
